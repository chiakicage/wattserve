...
- prompt lengths: `512`, `1024`, `2048`, `8192`, `16384`
...
The batch runner also refreshes the repo-root `BENCHMARK.md` with the latest Markdown summary built from the newest `summary.csv`.
...
Latest batch results should be read from `BENCHMARK.md` and the corresponding `results/llama_replace_ln_prefill/<timestamp>/summary.csv`.
